...
var a11yMenubar = function (document) {
  ...
  function init(id) {
    ...
    var menubar = navElem.getElementByTagName('ul'); // Ideally there should only be one ul in navElem, but may as well loop.

    for (var i = 0; i < menubar.length; i++) {
      // Set role.
      menubar[i].setAttribute('role', 'menubar'); // Set aria-label.
